...
namespace SudokuSpice.RuleBased
{
    ...
    /// </summary>
    public interface IPuzzle : IReadOnlyPuzzleWithMutablePossibleValues
    {
        /// <summary>
        ...
        [SuppressMessage("Design", "CA1043:Use Integral Or String Argument For Indexers", Justification = "This makes sense with Coordinate, which removes any ambiguity between row and column order.")]
        new int? this[in Coordinate c] { get; set; }

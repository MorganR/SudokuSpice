...
namespace SudokuSpice.Constraints.Test
{
    public class BoxUniquenessConstraintTest
    {
        ...
        public void Constrain_ReturnsExpectedConstraints()
        {
            ...
            ConstraintTestingUtils.AssertPossibleSquareValueIsOnConstraint(matrix.GetSquare(new Coordinate(0, 0)).GetPossibleValue(value), headerAtFirstBoxValue);
            ConstraintTestingUtils.AssertPossibleSquareValueIsOnConstraint(matrix.GetSquare(new Coordinate(0, 1)).GetPossibleValue(value), headerAtFirstBoxValue);
            ConstraintTestingUtils.AssertPossibleSquareValueIsOnConstraint(matrix.GetSquare(new Coordinate(1, 0)).GetPossibleValue(value), headerAtFirstBoxValue);
            ConstraintTestingUtils.AssertPossibleSquareValueIsOnConstraint(matrix.GetSquare(new Coordinate(1, 1)).GetPossibleValue(value), headerAtFirstBoxValue);
        }
